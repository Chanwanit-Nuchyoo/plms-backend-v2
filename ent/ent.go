...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			class_lab_status.Table:       class_lab_status.ValidColumn,
			class_user_role.Table:        class_user_role.ValidColumn,
			course.Table:                 course.ValidColumn,
			lab.Table:                    lab.ValidColumn,
			lab_problem.Table:            lab_problem.ValidColumn,
			lab_problem_submission.Table: lab_problem_submission.ValidColumn,
			post.Table:                   post.ValidColumn,
			testcase.Table:               testcase.ValidColumn,
			testcase_submission.Table:    testcase_submission.ValidColumn,
			topic.Table:                  topic.ValidColumn,
			topic_file_mats.Table:        topic_file_mats.ValidColumn,
