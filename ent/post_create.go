...
func (pc *PostCreate) SetClassID(i int) *PostCreate {
	pc.mutation.SetClassID(i)
	return pc
}
...
func (pc *PostCreate) SetClass(c *Class) *PostCreate {
	return pc.SetClassID(c.ID)
}
...
func (pc *PostCreate) check() error {
	if _, ok := pc.mutation.ClassID(); !ok {
		return &ValidationError{Name: "class_id", err: errors.New(`ent: missing required field "Post.class_id"`)}
	}
	...
	if _, ok := pc.mutation.ClassID(); !ok {
		return &ValidationError{Name: "class", err: errors.New(`ent: missing required edge "Post.class"`)}
	}
	if _, ok := pc.mutation.AuthorID(); !ok {
