...
func (pq *PostQuery) QueryClass() *ClassQuery {
...
func (pq *PostQuery) WithClass(opts ...func(*ClassQuery)) *PostQuery {
	query := (&ClassClient{config: pq.config}).Query()
...
func (pq *PostQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Post, error) {
	...
	if query := pq.withClass; query != nil {
		if err := pq.loadClass(ctx, query, nodes, nil,
			func(n *Post, e *Class) { n.Edges.Class = e }); err != nil {
			return nil, err
		}
	}
...
func (pq *PostQuery) loadClass(ctx context.Context, query *ClassQuery, nodes []*Post, init func(*Post), assign func(*Post, *Class)) error {
...
func (pq *PostQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := pq.ctx.Fields; len(fields) > 0 {
		...
		if pq.withClass != nil {
			_spec.Node.AddColumnOnce(post.FieldClassID)
		}
