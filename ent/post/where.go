...
func ClassID(v int) predicate.Post {
	return predicate.Post(sql.FieldEQ(FieldClassID, v))
}
...
func ClassIDEQ(v int) predicate.Post {
	return predicate.Post(sql.FieldEQ(FieldClassID, v))
}

// ClassIDNEQ applies the NEQ predicate on the "class_id" field.
func ClassIDNEQ(v int) predicate.Post {
	return predicate.Post(sql.FieldNEQ(FieldClassID, v))
}

// ClassIDIn applies the In predicate on the "class_id" field.
func ClassIDIn(vs ...int) predicate.Post {
	return predicate.Post(sql.FieldIn(FieldClassID, vs...))
}

// ClassIDNotIn applies the NotIn predicate on the "class_id" field.
func ClassIDNotIn(vs ...int) predicate.Post {
	return predicate.Post(sql.FieldNotIn(FieldClassID, vs...))
}
...
func HasClassWith(preds ...predicate.Class) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		step := newClassStep()
