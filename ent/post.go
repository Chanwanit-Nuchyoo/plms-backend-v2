...
func (e PostEdges) ClassOrErr() (*Class, error) {
	if e.loadedTypes[0] {
		if e.Class == nil {
...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case post.FieldID, post.FieldClassID, post.FieldAuthorID:
...
// QueryClass queries the "class" edge of the Post entity.
func (po *Post) QueryClass() *ClassQuery {
	return NewPostClient(po.config).QueryClass(po)
}
...
func (po *Post) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", po.ClassID))
	builder.WriteString(", ")
